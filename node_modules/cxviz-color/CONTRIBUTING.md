...
Thank you for your interest in `cxviz-color`, an open source project
administered by StrongLoop.

Contributing to `cxviz-color` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/cxviz-color)
